...
from _hf_test_utils import HFLoadErrorTestsMixin
...
class TestGroundingDinoBackendLoadErrors(HFLoadErrorTestsMixin, unittest.TestCase):
    backend_cls = GroundingDinoBackend
    processor_patch_target = "transformers.AutoProcessor.from_pretrained"
    model_patch_target = "transformers.AutoModelForZeroShotObjectDetection.from_pretrained"
    task_phrase = "open-vocabulary detection (grounding-dino)"
