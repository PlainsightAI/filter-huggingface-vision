...
class TestImageClassificationBackendLoadErrors(HFLoadErrorTestsMixin, unittest.TestCase):
    backend_cls = ImageClassificationBackend
    processor_patch_target = "transformers.AutoImageProcessor.from_pretrained"
    model_patch_target = "transformers.AutoModelForImageClassification.from_pretrained"
    task_phrase = "image classification"
