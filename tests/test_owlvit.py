...
class TestOwlVitBackendLoadErrors(HFLoadErrorTestsMixin, unittest.TestCase):
    backend_cls = OwlVitBackend
    processor_patch_target = "transformers.OwlViTProcessor.from_pretrained"
    model_patch_target = "transformers.OwlViTForObjectDetection.from_pretrained"
    task_phrase = "zero-shot detection (owl-vit)"
